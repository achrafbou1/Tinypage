 ...
 * Stripe Secret
 */
if (process.env.PAYMENTS_STRIPE_SECRET) {
    config.payments.stripeSecret = process.env.PAYMENTS_STRIPE_SECRET;
}

/**
 * Stripe Webhook Secret
 */
if (process.env.PAYMENTS_STRIPE_WEBHOOK_SECRET) {
    config.payments.stripeWebhookSecret = process.env.PAYMENTS_STRIPE_WEBHOOK_SECRET;
}
